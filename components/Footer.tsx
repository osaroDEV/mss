        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="text-2xl font-bold mb-4">
              Michael Stevens
              <span className="block text-lg font-normal text-gold-400">Solicitors</span>
            </div>
            <p className="text-neutral-300 mb-4">
              Providing exceptional legal services with integrity, expertise, and personal attention for over 25 years.
            </p>
            <div className="flex items-center text-sm text-neutral-300">
              <Clock className="h-4 w-4 mr-2" />
              <span>Regulated by the Solicitors Regulation Authority</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-neutral-300">123 Legal Street</p>
                  <p className="text-neutral-300">London, EC1A 1BB</p>
                </div>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 mr-3 text-gold-400" />
                <p className="text-neutral-300">+44 (0) 20 7123 4567</p>
              </div>
              <div className="flex items-center">
                <Mail className="h-5 w-5 mr-3 text-gold-400" />
                <p className="text-neutral-300">info@michaelstevenssolicitors.co.uk</p>
              </div>
              <div className="flex items-start">
        ...
        <div className="border-t border-primary-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/terms" className="text-neutral-300 hover:text-white text-sm transition-colors">Terms of Service</Link>
              <Link href="/cookies" className="text-neutral-300 hover:text-white text-sm transition-colors">Cookie Policy</Link>
            </div>
          </div>
        </div>
      </div>
